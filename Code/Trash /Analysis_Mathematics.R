...
my_theme <- theme(
  ...
  # Use a light color for the background of the plot aknd the panel.
...
school_data <- read_excel("school_data_ämnen.xlsx", sheet = "Mathematics")
...
stargazer::stargazer(
  ...
  align = TRUE,
  dep.var.caption = "",
  dep.var.labels = "Share of Student with F in Mathematics",
